# Contributing to the Mohr's Circle Manim Plugin
Firstly, thank you for considering making a contribution to the plugin, it is really appreciated! 

## Contribution Rules / Considerations
If you would like to contribute to the project, I would ask that you follow the following few rules / considerations:
...
- Due to my role as a Lecturer, Friday evenings is generally the period where I will address issues / perform PR code reviews.

## Project Setup
Please see the [following guide](https://pypi.org/project/manim-plugintemplate/) to set up Manim plugins. It would also 
be wise to actually [install Manim](https://docs.manim.community/en/stable/installation.html) on your machine as well, haha.
I am unable to give any support on installation for Windows / Mac Users, as I only use Linux personally.

## Queries
Do not hesitate to contact me for any queries you may have about the project! I am always happy to answer people's questions!